...
export default defineConfig({
  ...
  define: {
    ...
    'import.meta.env.VITE_RESTAURANT_SLUG': JSON.stringify(process.env.VITE_RESTAURANT_SLUG || 'chianti'),
    'import.meta.env.VITE_RESTAURANT_NAME': JSON.stringify(process.env.VITE_RESTAURANT_NAME || 'Chianti Ristorante'),
