...
export default defineConfig({
  plugins: [react()],
  define: {
    'import.meta.env.VITE_API_BASE': JSON.stringify('http://localhost:8005'),
    'import.meta.env.VITE_WS_BASE': JSON.stringify('ws://localhost:8005'),
    'import.meta.env.VITE_RESTAURANT_SLUG': JSON.stringify('amado'),
    'import.meta.env.VITE_RESTAURANT_NAME': JSON.stringify('Cafe Handcrafted'),
