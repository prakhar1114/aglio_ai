...
export default defineConfig({
  ...
  define: {
    ...
    'import.meta.env.VITE_RESTAURANT_SLUG': JSON.stringify(process.env.VITE_RESTAURANT_SLUG || 'freesia'),
    'import.meta.env.VITE_RESTAURANT_NAME': JSON.stringify(process.env.VITE_RESTAURANT_NAME || 'Freesia Cafe'),
